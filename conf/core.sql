...
CREATE TABLE if not exists core_fact (id integer primary key AUTOINCREMENT, op_id integer, link_id integer, fact text, value text, score integer, group_id integer, action integer, UNIQUE(op_id, fact, value) ON CONFLICT IGNORE);
