...
CREATE TABLE if not exists core_agent (id integer primary key AUTOINCREMENT, hostname text, paw text, checks integer, last_seen date, platform text, server text);
