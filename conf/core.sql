...
CREATE TABLE if not exists core_agent_father (id integer primary key AUTOINCREMENT, father text, child text, correlation_date date, UNIQUE(child) ON CONFLICT REPLACE);
