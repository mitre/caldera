...
CREATE TABLE if not exists core_rule (id integer primary key AUTOINCREMENT, rule_id text, name text, action integer, fact text, match text, UNIQUE(name) ON CONFLICT IGNORE);
