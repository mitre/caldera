...
class RestApi(BaseWorld):
    ...
    async def download_file(self, request):
        try:
            ...
            raise web.HTTPNotFound(body='File not found')
        except Exception as e:
            raise web.HTTPNotFound(body=str(e))
        ...
        if request.query.get('file'):
            try:
                ...
                if not is_in_exfil_dir(file):
                    raise web.HTTPNotFound(body="File not found in exfil dir")
                ...
                raise web.HTTPNotFound(body=str(e))
        raise web.HTTPBadRequest(body='A file needs to be specified for download')
