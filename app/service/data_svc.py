...
class DataService:
    ...
    async def create_fact(self, property, value, source_id, score, blacklist, group_id=None, link_id=None):
        await self.dao.create('core_fact', dict(property=property, value=value, source_id=source_id,
                                                score=score, blacklist=blacklist, group_id=group_id, link_id=link_id))
