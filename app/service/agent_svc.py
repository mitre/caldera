...
class AgentService(BaseService):
    ...
    async def handle_heartbeat(self, paw, hostname, username, platform, server, group, executors, architecture, location, pid, ppid, sleep):
        """
        ...
        if agent:
            ...
            queued = dict(last_seen=now, paw=paw, platform=platform, server=server, host_group=group,
                          ...
                          trusted=True, last_trusted_seen=now, sleep=sleep, hostname=hostname, username=username)
