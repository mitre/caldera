...
```
> Alternatively, you can run our [install script](https://caldera.readthedocs.io/en/latest/Install-script.html) which will install several more dependencies that super-power your CALDERA server instance.
