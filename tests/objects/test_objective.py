...
class TestGoal:
    ...
    def test_satisfied(self):
        ...
        assert test_goal.satisfied(all_facts=[Fact(name='target', value='value')]) is True

    def test_multi_satisfied(self):
        test_goal = Goal(target='target', value='value', count=3)
        test_fact = Fact(name='target', value='value')
    ...
    def test_operators(self):
        ...
        test_facta = Fact(name='target', value=1)
        test_factb = Fact(name='target', value=2)
        test_factc = Fact(name='target', value='test')
    ...
    def test_goals_satisfied(self):
        ...
        test_facta = Fact(name='target', value='value')
        test_factb = Fact(name='target2', value='value2')
